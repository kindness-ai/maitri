...
sudo tee /etc/systemd/system.conf.d/99-maitri-nofile.conf >/dev/null <<'EOF'
[Manager]
DefaultLimitNOFILE=65536:524288
EOF

sudo cp /etc/systemd/system.conf.d/99-maitri-nofile.conf \
        /etc/systemd/user.conf.d/99-maitri-nofile.conf

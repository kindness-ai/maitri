...
export LOGO_PATH="$MAITRI_PATH/logo.txt"
...
# maitri Spark theme for gum confirm
export GUM_CONFIRM_PROMPT_FOREGROUND="6"     # Cyan for prompt
export GUM_CONFIRM_SELECTED_FOREGROUND="0"   # Dark text on selected
export GUM_CONFIRM_SELECTED_BACKGROUND="4"   # Blue (Spark accent) for selected

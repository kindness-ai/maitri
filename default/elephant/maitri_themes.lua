--
-- Dynamic maitri Theme Menu for Elephant/Walker
--
Name = "maitrithemes"
NamePretty = "maitri Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/maitri/themes"
  local maitri_path = os.getenv("MAITRI_PATH") or ""
  local default_theme_dir = maitri_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "maitri-theme-set " .. theme_name,
            },
          })
        end
      end
